...
export const metadata: Metadata = {
  ...
  description:
    "Automation hardware design and sustainable server recycling from InnoKnots Oy, Helsinki.",
};
    ...
    <main className="page-enter flex min-h-svh flex-col">
      ...
      <div className="flex flex-1 flex-col justify-center px-8 pb-24 md:px-12">
        ...
        <p className="mt-4 max-w-[46ch] text-lg text-navy/70">
          Automation hardware design and sustainable server recycling. This page
          is being written after Sailing.
        </p>
      </div>
    </main>
  );
